...
from jenkins.bokchoy_db_pull_request import (_get_github_token, _authenticate_with_github,
                                             _connect_to_repo, _get_file_sha, _read_file_contents,
                                             _file_has_changed, _create_branch, _update_file,
                                             _create_pull_request, main)
...
class BokchoyPullRequestTestCase(TestCase):
    ...
    @patch('jenkins.bokchoy_db_pull_request._get_github_token',
           return_value="token")
    ...
    def test_no_changes(
        ...
        file_sha_mock, repo_mock, github_mock, token_mock
    ):
        """
